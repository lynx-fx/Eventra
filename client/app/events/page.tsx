...
export default function EventsPage() {
    ...
    const categories = ["All", "Music", "Sports", "Theatre", "Festival", "Concert", "Workshop", "Other"];
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0 w-full md:w-auto no-scrollbar">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all border ${selectedCategory === cat

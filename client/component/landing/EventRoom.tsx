...
const EventRoom = () => {
    return (
        <section className="py-24 bg-[#141416] relative overflow-hidden">
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-600/20 text-purple-400 text-sm font-semibold mb-6">
                        ...
                        <div className="flex flex-col gap-6 mb-10">
                            <div className="flex items-start gap-4">
                                <div className="bg-[#1c1c1e] p-3 rounded-xl border border-white/10">
                                    <Camera className="w-6 h-6 text-purple-500" />
                                </div>
                                <div>
                                    <h4 className="text-white font-bold text-lg">Live Photo Feed</h4>
                                    <p className="text-gray-500 text-sm">Real-time photos from everyone at the event.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="bg-[#1c1c1e] p-3 rounded-xl border border-white/10">
                                ...
                                <div>
                                    <h4 className="text-white font-bold text-lg">Community Connection</h4>
                                    <p className="text-gray-500 text-sm">Find friends and meet people with similar interests.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="grid grid-cols-2 gap-4 relative">
                            <div className="space-y-4 pt-12">
                                <div className="rounded-2xl overflow-hidden shadow-2xl border border-white/10 transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">

  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Login card */}
        <div className="bg-white border border-slate-200 rounded-2xl shadow-xl p-8 space-y-6 backdrop-blur-sm">
          <div>
          ...
          {/* Google login button */}
          <button className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors duration-200 font-medium text-slate-700 hover:text-slate-900">
